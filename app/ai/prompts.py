...
def build_user_message(context: UserContext, job: Job) -> str:
    ...
    return (
        ...
        "- A vaga e remota mas restrita a candidatos de um pais/regiao especifico que "
        "exclui o Brasil (ex: 'US-based only', 'EU residents only', exige visto de "
        "trabalho em outro pais) - considerando a restricao de elegibilidade do candidato "
        "informada no contexto acima, se houver.\n"
